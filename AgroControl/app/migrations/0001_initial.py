    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('produto', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='movimentos', to='app.produto')),
            ],
        ),
        migrations.CreateModel(
            name='Animal',
            fields=[
                ...
                ('propriedade', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='animais', to='app.propriedade')),
            ],
        ),
    ]
